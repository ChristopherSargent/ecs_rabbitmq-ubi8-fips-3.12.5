...
# Build base images
This repository contains the necessary source code files to deploy the following container images for rabbitmq 3.12.5 erlang 26.1 openssl 3.0.8. For additional details, please email at [c.sargent-ctr@ecstech.com](mailto:c.sargent-ctr@ecstech.com).
